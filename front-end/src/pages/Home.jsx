...
// استيراد أيقونات Lucide التي سنستخدمها
import {
  BookOpen,
  BookText,
  Video,
  ...
  <div className="font-[Tajawal] text-right" dir="rtl">
    ...
    <section className="pt-32 pb-16 md:py-40 bg-gradient-to-r from-green-800 to-green-600 text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto">
          احصل على إجازة في القراءات القرآنية من خلال نخبة من المشايخ المتخصصين
          وبطرق حديثة تجمع بين الأصالة والمعاصرة
        </p>
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { name: "الشيخ عبد الرحمن العوسي", role: "استاذ القراءات العشر" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8 text-lg">
              حصول الطالب على شهادة تثبت مستواه وإتقانه للقرآن الكريم وعلومه.
              نقدم اختبارات إلكترونية متطورة ومقابلات عبر الفيديو مع المشايخ
              المتخصصين.
            </p>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto bg-green-50 rounded-lg p-8 shadow-lg text-center">
          ...
          <p className="text-gray-600 mb-8 text-lg">
            ...
            المشايخ والمقرئين. سجل دخولك الآن أو أنشئ حساباً جديداً لبدء رحلتك
            مع القرآن الكريم وعلومه.
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a
              href="/login"
          ...
          <div className="mt-8 text-gray-500">
            <p>
              لديك سؤال؟{" "}
              <a href="/contactus" className="text-green-600 hover:underline">
                تواصل معنا
              </a>
            </p>
          </div>
